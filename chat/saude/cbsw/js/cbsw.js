...
function PrimeiraResposta() {
  ...
  if(aberto != true){
    ...
    var url = "http://sofia.softwell.com.br/sofia/respondemobileportal.rule?proj=05aa2922-1cca-48a1-8af5-71e72cb24133&sys=SSA&pergunta=&latitude=&longitude=&id=undefined&ini=s&usu=APA91bEMuk931CWQUeu340pyKgQ83jR1lcZLMWlYZZNIgkQcI-n65Roxauy_ukoOJe4sNGm9C3HvtB6RWr-es6UZ0n0JnHf6Dr3FjHmqdOJQREzwJ_kYHt8&sessao="+sessao
    
    var data = new Date();
    
    if((data.getHours() > 0) && (data.getHours() < 13)){
    //BOM DIA
    document.getElementById('cbsw_dialogue').innerHTML = "<div class='cbsw_rr cbsw_return my-2'><span class='cbsw_bubble alert alert-info d-inline-block shadow'>Bom dia, eu sou a <b>Sara</b>! O que você deseja saber sobre o Maker?</span></div>";   
        }else if((data.getHours() > 13) && (data.getHours() < 18)){
    //BOA TARDE
    document.getElementById('cbsw_dialogue').innerHTML = "<div class='cbsw_rr cbsw_return my-2'><span class='cbsw_bubble alert alert-info d-inline-block shadow'>Boa tarde, eu sou a <b>Sara</b>!</span></div>";     
        }else{
    //BOA NOITE
    document.getElementById('cbsw_dialogue').innerHTML = "<div class='cbsw_rr cbsw_return my-2'><span class='cbsw_bubble alert alert-info d-inline-block shadow'>Boa noite, eu sou a <b>Sara</b>!</span></div>"; 
        }
...
function resposta(texto,id) {    
    var historico = document.getElementById('cbsw_dialogue').innerHTML;    
    var url = "http://sofia.softwell.com.br/sofia/respondemobileportal.rule?proj=05aa2922-1cca-48a1-8af5-71e72cb24133&sys=SSA&pergunta="+URLEncode2(texto)+"&latitude=&longitude=&id=undefined&ini=n&usu=APA91bEMuk931CWQUeu340pyKgQ83jR1lcZLMWlYZZNIgkQcI-n65Roxauy_ukoOJe4sNGm9C3HvtB6RWr-es6UZ0n0JnHf6Dr3FjHmqdOJQREzwJ_kYHt8&sessao="+sessao
